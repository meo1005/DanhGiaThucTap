...
namespace DanhGiaThucTap.ViewModel
{
    public class LenhDieuKhienViewModel : BaseViewModel
    {
        ...
        public LenhDieuKhienViewModel()
        {
            ...
            ItemGT = new ItemGiaTriModel { GTBannerGia = 1765.5, GTMoCua = 1.196, GTCao = 1.132, GTThap = 128.1, GTTongHD = 20.854, GTKLMo = 27.333, GTDuMua00 = 8, GTDuBan01 = 47, GT01 = 138.2, GT00 = 185.7, GTTran = 1952.72, GTTB = 118.8, GTSan = 108.6, TileMua = 10, TileBan = 90, GT10 = 132.64, GT11 = 137.72, GT20 = 188.123, GT21 = 135.32, GTDuBan11 = 2, GTDuBan21 = 23, GTDuMua10 = 12, GTDuMua20 = 34, KLMax = 1 };
        ...
        private void OnClickBtnPlus(string key)
        {
            ...
            else if (key.Equals("GiaPlus"))
            {
                ...
                {
                    if (double.Parse(EntryGia) > ItemGT.GTTran || double.Parse(EntryGia) < ItemGT.GTSan)
                    {
                        App.Current.MainPage.DisplayAlert("Thông báo", "Giá điều kiện không được nằm ngoài biên độ trần sàn", "OK");
                        EntryGia = ItemGT.GTTB.ToString();
                    }
                    else
                    {
                        ...
                        {
                            App.Current.MainPage.DisplayAlert("Thông báo", "Giá không được cao hơn giá trần", "OK");
                        }
                        else
                        {
        ...
        private void OnClickItemOnNavigationList(ItemListNavigationModel item)
        {
            ...
            if (item.ID == 0)
            {
                ItemGT = new ItemGiaTriModel { GTBannerGia = 1358.5, GTMoCua = 1.191, GTCao = 1.192, GTThap = 1188.2, GTTongHD = 20.82, GTKLMo = 27.33, GTDuMua00 = 12, GTDuBan01 = 30, GT01 = 181.9, GT00 = 118.8, GTTran = 1772.32, GTTB = 125.18, GTSan = 105.6, TileMua = 23, TileBan = 77, GT10 = 132.64, GT11 = 137.72, GT20 = 188.123, GT21 = 135.32, GTDuBan11 = 2, GTDuBan21 = 23, GTDuMua10 = 12, GTDuMua20 = 34, KLMax = 2 };
            }
            else if (item.ID == 1)
            {
                ItemGT = new ItemGiaTriModel { GTBannerGia = 1399.1, GTMoCua = 1.131, GTCao = 1191, GTThap = 1128.3, GTTongHD = 20.242, GTKLMo = 27.313, GTDuMua00 = 7, GTDuBan01 = 21, GT01 = 188.3, GT00 = 138.6, GTTran = 1847.93, GTTB = 128.88, GTSan = 115.6, TileMua = 50, TileBan = 50, GT10 = 132.64, GT11 = 137.72, GT20 = 188.123, GT21 = 135.32, GTDuBan11 = 2, GTDuBan21 = 23, GTDuMua10 = 12, GTDuMua20 = 34, KLMax = 3 };
            }
            else if (item.ID == 2)
            {
                ItemGT = new ItemGiaTriModel { GTBannerGia = 1354.9, GTMoCua = 1.191, GTCao = 1.196, GTThap = 1178.7, GTTongHD = 20.832, GTKLMo = 27.383, GTDuMua00 = 3, GTDuBan01 = 17, GT01 = 118.8, GT00 = 168.7, GTTran = 1911.214, GTTB = 108.8, GTSan = 96.6, TileMua = 59.26, TileBan = 40.74, GT10 = 132.64, GT11 = 137.72, GT20 = 188.123, GT21 = 135.32, GTDuBan11 = 2, GTDuBan21 = 23, GTDuMua10 = 12, GTDuMua20 = 34, KLMax = 4 };
            }
            else
            {
                ItemGT = new ItemGiaTriModel { GTBannerGia = 1765.5, GTMoCua = 1.196, GTCao = 1.132, GTThap = 128.1, GTTongHD = 20.854, GTKLMo = 27.333, GTDuMua00 = 8, GTDuBan01 = 47, GT01 = 138.2, GT00 = 185.7, GTTran = 1952.72, GTTB = 148.8, GTSan = 108.6, TileMua = 10, TileBan = 90, GT10 = 132.64, GT11 = 137.72, GT20 = 188.123, GT21 = 135.32, GTDuBan11 = 2, GTDuBan21 = 23, GTDuMua10 = 12, GTDuMua20 = 34, KLMax = 5 };
            }
            if (Index == 0 || Index == 1)
            {
                EntryGiaDK = ItemGT.GTBannerGia.ToString();
