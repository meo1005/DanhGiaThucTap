...
namespace DanhGiaThucTap.ViewModel
{
    public class LenhDieuKienViewModel : BaseViewModel
    {
        ...
        {
            ListOnNavigation.Add(new ItemListNavi { Ma= "VN30F2106" });
            ListOnNavigation.Add(new ItemListNavi { Ma = "VN30F2105" });
            ListOnNavigation.Add(new ItemListNavi { Ma = "VN30F2112" });
            ListOnNavigation.Add(new ItemListNavi { Ma = "VN30F2109" });
            ListOnNavigation.Add(new ItemListNavi { Ma = "GB05F2106" });
            ListOnNavigation.Add(new ItemListNavi { Ma = "GB05F2109" });
            ListOnNavigation.Add(new ItemListNavi { Ma = "GB10F2109" });
            ListOnNavigation.Add(new ItemListNavi { Ma = "GB10F2106" });
        }
    }
}
